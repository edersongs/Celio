 ...
 * 
 */
package com.cprint.system.thymeleaf.processor;
 ...
 *
 */
public class ClassForErrorTagProcessor extends AbstractAttributeTagProcessor {

	private static final String NOME_ATRIBUTO = "classforerror";
	private static final int PRECEDENCIA = 1000;

	public ClassForErrorTagProcessor(String dialectPrefix) {
